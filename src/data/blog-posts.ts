...
export const blogPosts: BlogPost[] = [
  {
    ...
    keywords: [
      ...
      "decisiones antes de disenar una web",
      "estrategia para pagina web",
      "contenido para sitio web",
      "presupuesto de pagina web",
      "AionSite",
    ],
    headings: [
