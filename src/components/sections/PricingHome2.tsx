...
export function PricingHome2() {
  ...
  return (
    <section
      ...
      className="bg-slate-950 py-16 text-white md:py-28"
    >
      <Container>
        ...
        <div className="grid rounded-2xl border border-white/10 lg:grid-cols-2">
          <div className="divide-y divide-white/10 bg-slate-950 p-8 lg:p-12">
            ...
            {hasWebsite && (
              <div className="py-8">
                <h3 className="mb-5 text-lg font-medium">
                  Que tipo de sitio necesitas?
                </h3>
                <div className="space-y-4">
                  {[
                    ["basic", "Sitio basico", "$2,000"],
                ...
                <input aria-label="Numero de paginas extra" type="range" min="0" max="30" step="1" value={pages} onChange={(event) => setPages(Number(event.target.value))} className="h-2 w-full cursor-pointer accent-blue-400" />
            ...
            {hasSocial && (
              <div className="py-8">
                ...
                <input aria-label="Publicaciones extra para redes" type="range" min="0" max="50" step="10" value={posts} onChange={(event) => setPosts(Number(event.target.value))} className="h-2 w-full cursor-pointer accent-blue-400" />
                ...
                <p className="mt-3 text-xs text-slate-400">
                  ...
                  semana. Cada 10 publicaciones extra por mes: +$200.
                </p>
              </div>
            )}
            {hasWebsite && (
                    ...
                    >
                      <span className="flex items-center gap-3">
                        <input
                          ...
                          className="h-5 w-5 appearance-none rounded border-2 border-slate-500 checked:border-blue-400 checked:bg-blue-400"
                        />
                        {label as string}
                      </span>
          ...
          <div className="min-h-[717px] border-t border-white/10 bg-slate-900/70 p-8 lg:rounded-r-2xl lg:border-l lg:border-t-0 lg:p-12">
            <div className="lg:sticky lg:top-24">
              ...
              <p className="mt-3 max-w-md text-sm leading-6 text-slate-400">
                Una estimacion basada en tu servicio, paginas, publicaciones,
              ...
              <div className="mt-8 space-y-3">
                <EstimateCard
                  ...
                  price={agency}
                  subtitle="+ Mas tiempo y costos adicionales"
                />
                <EstimateCard
                  title="Un freelancer normalmente cobra minimo"
                  price={freelancer}
                  subtitle="+ Mas vueltas y seguimiento"
                />
                ...
                <p className="mt-8 text-xs leading-5 text-slate-500">
                  Esta estimacion es un punto de partida. El alcance, la inversion y
                  el tiempo final se confirman despues de conversar.
                </p>
              </div>
            </div>
          </div>
...
function EstimateCard({
  ...
  return (
    <div className="rounded-2xl bg-white/10 p-6">
      ...
      <p className="mt-2 text-4xl font-bold tracking-tight"><AnimatedMoney value={price} /></p>
