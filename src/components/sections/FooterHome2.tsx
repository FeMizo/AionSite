    ...
    <footer className="relative overflow-hidden bg-slate-950 text-white">
      ...
      <div className="mx-auto w-[calc(100%-32px)] max-w-[1820px] py-12 sm:w-[calc(100%-48px)] lg:py-16">
        <div className="grid gap-12 lg:grid-cols-[minmax(320px,1.25fr)_repeat(2,minmax(150px,0.42fr))_minmax(180px,0.5fr)] lg:gap-16 lg:min-h-[330px]">
          <div><h2 className="max-w-2xl font-display text-[clamp(2.35rem,3.5vw,3.9rem)] font-light leading-[1.06]">Diseño web, ecommerce, SEO e IA para negocios.</h2><p className="mt-6 max-w-md text-sm leading-6 text-slate-400">{data.description}</p></div>
          <FooterNav title="Enlaces" links={data.navigation.slice(0, 4)} />
          <FooterNav title="Más enlaces" links={data.navigation.slice(4)} />
